...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            'financebundle\\controller\\basecontroller' => 'FinanceBundle\\Controller\\BaseController',
            'financebundle\\service\\baseservice' => 'FinanceBundle\\Service\\BaseService',
        ...
        $this->fileMap = [
            'FinanceBundle\\Controller\\BaseController' => 'getBaseControllerService.php',
            'FinanceBundle\\Service\\BaseService' => 'getBaseServiceService.php',
            ...
            'service_locator.jlaxwku' => 'getServiceLocator_JlaxwkuService.php',
        ...
        $this->privates = [
            ...
            'FinanceBundle\\Service\\BaseService' => true,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'FinanceBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/FinanceBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'FinanceBundle' => 'FinanceBundle\\FinanceBundle',
            ],
